...
@section('content')
<!-- Hero Section -->
<section class="hero-section" style="background: linear-gradient(rgba(44,95,141,0.5), rgba(63,170,122,0.5)), url('https://images.unsplash.com/photo-1573497620053-ea5300f94f21?w=1920&q=80') center/cover; min-height: 60vh; display: flex; align-items: center; color: white;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4 text-center mb-4 mb-lg-0">
                @if($member->photo)
                <div class="position-relative d-inline-block">
                    <img src="{{ str_starts_with($member->photo, 'http') ? $member->photo : asset('storage/' . $member->photo) }}" alt="{{ $member->name }}"
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="sidebar-sticky">
                    ...
                    <!-- Appointment Card -->
                    <div class="card mb-4 shadow-sm" style="background: linear-gradient(135deg, var(--primary-green), var(--light-green)); color: white;">
